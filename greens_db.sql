...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2025 at 03:36 PM
...
INSERT INTO `listings` (`id`, `user_id`, `category_id`, `title`, `description`, `price`, `location`, `status`, `featured`, `created_at`, `updated_at`, `long_description`, `rating`, `subcategory`, `company_name`, `phone`, `email`, `avatar`, `images`, `tags`, `experience`, `social_media`, `clicks`, `published_at`, `is_featured`) VALUES
(16, 1, 1, 'Profesjonalne czyszczenie maszyn rolniczych', 'Szybkie i skuteczne mycie kombajnów, traktorów i innych maszyn.', 250.00, 'Warszawa', 'active', 1, '2025-08-08 12:00:00', '2025-08-08 12:00:00', 'Oferujemy kompleksowe usługi czyszczenia maszyn rolniczych z dojazdem do klienta na terenie całej Polski. Używamy profesjonalnych środków, które są bezpieczne dla środowiska. Gwarantujemy satysfakcję i szybkie terminy realizacji.', 4.8, 'Mycie i konserwacja', 'AgroClean Sp. z o.o.', '22 123 45 67', 'kontakt@agroclean.pl', NULL, '[\"/images/agroclean_1.jpg\", \"/images/agroclean_2.jpg\"]', '[\"czyszczenie\", \"rolnictwo\", \"maszyny\", \"konserwacja\"]', '10 lat doświadczenia', '{\"facebook\": \"http://facebook.com/agroclean\"}', 0, '2025-08-08 12:00:00', 1),
(17, 2, 2, 'Sprzedaż ekologicznych warzyw i owoców', 'Świeże, certyfikowane produkty prosto z naszej farmy pod Piasecznem.', 15.50, 'Piaseczno', 'active', 1, '2025-08-07 08:15:00', '2025-08-08 09:59:30', 'Zapraszamy do zakupu naszych ekologicznych produktów. Uprawiamy bez pestycydów i sztucznych nawozów. W ofercie m.in. pomidory, ogórki, jabłka i truskawki sezonowe. Możliwość dostawy na terenie Warszawy i okolic.', 4.9, 'Warzywa i owoce', 'EkoFarma Mazowsze', '22 756 89 12', 'mariusz@ekofarma.pl', NULL, '[\"/images/ekofarma_1.jpg\", \"/images/ekofarma_2.jpg\"]', '[\"eko\", \"warzywa\", \"owoce\", \"bio\", \"zdrowa żywność\"]', 'Firma rodzinna od 5 lat', NULL, 0, '2025-08-07 08:15:00', 0),
(18, 3, 3, 'Instalacja paneli fotowoltaicznych', 'Montaż systemów fotowoltaicznych dla domów i firm. Profesjonalne doradztwo.', 25000.00, 'Kraków', 'inactive', 1, '2025-08-06 09:00:00', '2025-08-08 09:59:31', 'Zajmujemy się kompleksowym montażem instalacji fotowoltaicznych. Pomagamy w uzyskaniu dofinansowania i załatwieniu wszelkich formalności. Pracujemy na panelach renomowanych producentów.', 4.5, 'Fotowoltaika', 'Green Solutions', '12 345 67 89', 'info@greensolutions.pl', NULL, '[\"/images/greensolutions_1.jpg\"]', '[\"fotowoltaika\", \"panele słoneczne\", \"oze\", \"energia\"]', 'Ponad 100 zrealizowanych instalacji', '{\"website\": \"http://greensolutions.pl\"}', 0, NULL, 0);
...
INSERT INTO `messages` (`id`, `user_id`, `company_id`, `sender_name`, `sender_email`, `sender_phone`, `subject`, `message`, `status`, `is_urgent`, `is_read`, `admin_reply`, `replied_at`, `replied_by`, `created_at`, `updated_at`) VALUES
(21, 1, 1, 'Adam Trojecki', 'adam.trojecki@interia.pl', '669774897', 'Zapytanie o usługi AgroClean', 'Dzień dobry, interesuje mnie współpraca z Państwa firmą.', 'pending', 1, 0, NULL, NULL, NULL, '2025-08-08 08:30:00', '2025-08-08 08:30:00'),
(22, 2, 2, 'Adam Trojecki', 'adam@yellowevents.pl', '+58 123 123 123', 'Oferta dla EkoFarma', 'Szukam rozwiązań ekologicznych dla firmy.', 'pending', 0, 0, NULL, NULL, NULL, '2025-08-08 09:15:00', '2025-08-08 09:15:00'),
(23, 3, 3, 'Test User', 'test@example.com', NULL, 'Green Solutions - konsultacje', 'Czy świadczicie usługi konsultingowe?', 'approved', 0, 1, 'Tak, oferujemy szeroki zakres konsultacji.', '2025-08-07 14:30:00', 9, '2025-08-07 13:00:00', '2025-08-07 14:30:00');
